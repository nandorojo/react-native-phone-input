...
export default React.memo(
  React.forwardRef((props, ref) => <PhoneInput {...props} forwardRef={ref} />)
);
...
class PhoneInput extends Component {
  ...
  updateRef(props) {
    if (props.forwardRef) {
      props.forwardRef.current = {
        selectCountry: this.selectCountryFromRef
      };
    }
  }
    ...
    if (this.state.iso2 !== iso2) {
      ...
      if (countryData) {
        ...
        this.setState(
          ...
          newState => {
            console.log(
              "SHOULD HAVE UPDAATED NUMBER AND FLAG...",
              this.state.formattedNumber
            );
            this.onChangePhoneNumber(this.state.formattedNumber);
  ...
  render() {
    ...
    console.log("ISO 2 IN LIB RENDER", iso2);
